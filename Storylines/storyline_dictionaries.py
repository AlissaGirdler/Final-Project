...
Level_3_weather_storyline = {
    ...
    "good cold" : "\n\
        It is a little chilly out but\n\
        clear and calm.",

    "good warm" : "\n\
        The weather is perfect to finish\n\
        out the trip on a good note."

    "bad cold" "\n\
        Suddenly a freak blizzard rolls in\n\
        this was certainly unexpected",

    "bad warm" : "\n\
        A surprise and extreme heat wave hits,\n\
